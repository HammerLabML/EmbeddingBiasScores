...
from utils import normalize, cossim
from geometric_bias import GeometricBias, EmbSetList, EmbSet
...
class DirectBias(GeometricBias):
    ...
    def define_bias_space(self, attribute_sets: EmbSetList):
        assert len(self.A) >= 2, "need at least two attribute groups to measure bias!"
